...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.button onClick={onClickHandler} className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py2.5 flex items-center gap-2 rounded-full'
      ...
      className='mt-'>Generated images from imagify</motion.p>
    </motion.div>
  )
}
